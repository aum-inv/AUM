...
namespace OM.Vikala.Chakra.App.Mains.ChartForm
{
    public partial class QuantumChartForm : BaseForm
    {
        ...
        public QuantumChartForm(AverageTypeEnum averageType = AverageTypeEnum.Normal)
        {
            InitializeComponent();
        ...
        public QuantumChartForm(OriginSourceTypeEnum originSourceType = OriginSourceTypeEnum.Normal)
        {
            InitializeComponent();
