...
namespace OM.Vikala.Chakra.App.Mains.ChartForm
{
    public partial class QuantumChartHLForm : BaseForm
    {
        public bool IsShowCandle
        {
            set
            {
                chart1.IsShowCandle = chart2.IsShowCandle = value;
            }
        }
        ...
        public QuantumChartHLForm(AverageTypeEnum averageType = AverageTypeEnum.Normal)
        {
            InitializeComponent();
        ...
        public QuantumChartHLForm(OriginSourceTypeEnum originSourceType = OriginSourceTypeEnum.Normal)
        {
            InitializeComponent();
