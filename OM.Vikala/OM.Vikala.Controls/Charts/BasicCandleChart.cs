    ...
    public partial class BasicCandleChart : BaseChartControl
    {
        ...
        public override void View()
        {
            ...
            else if (BaseCandleChartType == BaseCandleChartTypeEnum.지)
            {
                ...
                double minPrice = ChartData.Min(m => m.QuantumLowPrice);                
                maxPrice = maxPrice + SpaceMaxMin;
                minPrice = minPrice - SpaceMaxMin;
                chart.ChartAreas[0].AxisY2.Maximum = maxPrice;
                chart.ChartAreas[0].AxisY2.Minimum = minPrice;
            ...
            {
                double maxPrice = ChartData.Max(m => m.VikalaHighPrice);
                double minPrice = ChartData.Min(m => m.VikalaLowPrice);
                maxPrice = maxPrice + SpaceMaxMin;
                minPrice = minPrice - SpaceMaxMin;
                chart.ChartAreas[0].AxisY2.Maximum = maxPrice;
                chart.ChartAreas[0].AxisY2.Minimum = minPrice;
        ...
        public void Annotation()
        {
            ...
            {
                var dataPoint = chart.Series[0].Points[idx];
                addImageAnnotation(item.EightRuleType, dataPoint);
                idx++;
            }
        }
        ...
        public void DisplayView()
        {
            ...
            if (viewLists != null)
            {
                ...
                if (BaseCandleChartType == BaseCandleChartTypeEnum.지)
                {
                    maxPrice = viewLists.Max(m => m.QuantumHighPrice);
                    minPrice = viewLists.Min(m => m.QuantumLowPrice);
                }
                else if (BaseCandleChartType == BaseCandleChartTypeEnum.천)
                {
                    maxPrice = viewLists.Max(m => m.VikalaHighPrice);
                    minPrice = viewLists.Min(m => m.VikalaLowPrice);
                }
        ...
        private void addImageAnnotation(EightRuleTypeEnum eightRuleType,  DataPoint point)
        {
            ...
            string imageName = "";
            switch (eightRuleType)
            {
                case EightRuleTypeEnum.건_1_111_양_태양 :
                    imageName = "111";
                    break;
                case EightRuleTypeEnum.태_2_011_음_태양:
                    imageName = "011";
                    break;
                case EightRuleTypeEnum.리_3_101_양_소음:
                    imageName = "101";
                    break;
                case EightRuleTypeEnum.진_4_001_음_소음:
                    imageName = "001";
                    break;
                case EightRuleTypeEnum.손_5_110_양_소양:
                    imageName = "110";
                    break;
                case EightRuleTypeEnum.감_6_010_음_소양:
                    imageName = "010";
                    break;
                case EightRuleTypeEnum.간_7_100_양_태음:
                    imageName = "100";
                    break;
                case EightRuleTypeEnum.곤_8_000_음_태음:
                    imageName = "000";
                    break;
            }
            ...
            ia.Image = System.Environment.CurrentDirectory + "\\Resources\\" + imageName + ".png";
