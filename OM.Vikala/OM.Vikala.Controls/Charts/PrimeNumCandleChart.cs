...
{
    public partial class PrimeNumCandleChart : BaseChartControl
    {
        public List<T_PrimeNumItemData> ChartData
        {
            get;
            set;
        }
        ...
        public override void View()
        {
            ...
            foreach (var item in ChartData)
            {
                ...
                if (WuXingType == WuXingTypeEnum.무극)
        ...
        public void DisplayView()
        {
            ...
            List<T_PrimeNumItemData> viewLists = null;
