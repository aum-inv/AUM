...
{
    public partial class CandleAntiCandleChart : BaseChartControl
    {
        ...
        public List<T_CandleAntiCandleItemData> ChartData
        {
            get;
            set;
        }
        public List<T_CandleAntiCandleItemData> ChartDataSub
        {
            get;
            set;
        }
        public void LoadData(string itemCode = ""
            , List<T_CandleAntiCandleItemData> chartData = null
        ...
        public void LoadData(string itemCode = ""
            , List<T_CandleAntiCandleItemData> chartData = null
            , List<T_CandleAntiCandleItemData> chartDataSub = null
            , Lib.Base.Enums.TimeIntervalEnum timeInterval = Lib.Base.Enums.TimeIntervalEnum.Day)
        {
        ...
        public override void View()
        {
            ...
            chart.Series[1].Enabled = chart.Series[2].Enabled = chart.Series[3].Enabled = chart.Series[4].Enabled = false;

            foreach (T_CandleAntiCandleItemData item in ChartData)
            {
            ...
            maxPrice1 = maxPrice1 + SpaceMaxMin;
            minPrice1 = minPrice1 - SpaceMaxMin;
            chart.ChartAreas[0].AxisY2.Maximum = maxPrice1;
            chart.ChartAreas[0].AxisY2.Minimum = minPrice1;
        ...
        public void DisplayView()
        {
            ...
            List<T_CandleAntiCandleItemData> viewLists = null;
