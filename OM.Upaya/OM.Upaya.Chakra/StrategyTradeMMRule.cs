...
{
    public class StrategyTradeMMRule : BaseTradeRule
    {
        //"UP↑", "DOWN↓", "UPDOWN↑↓", "DOWNUP↓↑"

        #region 속성

        public List<double> BasePriceUps { get; set; }
        public List<double> BasePriceDowns { get; set; }
        ...
        public StrategyTradeMMRule() : base(365)
        {            
        }
            ...
            try
            {
                ...
                {   
                    if (IsUseBuy)
                    {
                        ...
                        {
                            if (PointsUtil.IsMatchedUpDownPattern(PriceList, BasePriceUps, BasePriceDowns, BasePattern))
                            {
