...
{
    public class StrategyTradeMSRule : BaseTradeRule
    {
        //"UP↑", "DOWN↓", "UPDOWN↑↓", "DOWNUP↓↑"

        #region 속성

        public double BasePriceUp { get; set; } = 0;
        public double BasePriceDown { get; set; } = 0;
        ...
        public StrategyTradeMSRule() : base(365)
        {            
        }
