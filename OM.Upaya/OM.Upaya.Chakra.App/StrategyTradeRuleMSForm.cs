...
{
    public partial class StrategyTradeRuleMSForm : Form
    {
        StrategyTradeMSRule rule = new StrategyTradeMSRule();
        ...
        public StrategyTradeRuleMSForm()
        {
            InitializeComponent();
        ...
        private void tbBasePrice_TextChanged(object sender, EventArgs e)
        {
            ...
            rule.BasePriceUp = Convert.ToDouble(tbBasePriceUp.Text);
        }
        private void tbBasePriceDown_TextChanged(object sender, EventArgs e)
        {
            if (tbBasePriceDown.Text.Length == 0) return;
            rule.BasePriceDown = Convert.ToDouble(tbBasePriceDown.Text);
        }
