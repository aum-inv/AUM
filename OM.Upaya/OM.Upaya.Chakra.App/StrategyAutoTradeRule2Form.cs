...
{
    public partial class StrategyAutoTradeRule2Form : Form
    {
        ...
        public StrategyAutoTradeRule2Form()
        {
            InitializeComponent();
        ...
        private void BtnLoadCandle_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (cbxTime.SelectedIndex == 4) timeInterval = TimeIntervalEnum.Hour_01;
