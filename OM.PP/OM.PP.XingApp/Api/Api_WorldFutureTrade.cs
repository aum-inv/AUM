...
namespace OM.PP.XingApp.Api
{
    ...
    class Api_WorldFutureTrade : BaseTradeApi
    {
        ...
        {
            ItemCode = IsuCodeVal;            
            query.SetFieldData(inBlock, "RecCnt", 0, RecCnt);
            query.SetFieldData(inBlock, "OrdDt", 0, OrdDt);
            query.SetFieldData(inBlock, "BrnCode", 0, "");
            ...
            query.SetFieldData(inBlock, "CrcyCode", 0, "");
            query.SetFieldData(inBlock, "OvrsDrvtOrdPrc", 0, OvrsDrvtOrdPrc);
            query.SetFieldData(inBlock, "CndiOrdPrc", 0, CndiOrdPrc);
            query.SetFieldData(inBlock, "OrdQty", 0, OrdQty);            
            query.SetFieldData(inBlock, "DueYymm", 0, "");
            query.SetFieldData(inBlock, "ExchCode", 0, "");
