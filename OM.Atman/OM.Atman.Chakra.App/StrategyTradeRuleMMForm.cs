...
{
    public partial class StrategyTradeRuleMMForm : Form
    {
        StrategyTradeMMRule rule = new StrategyTradeMMRule();
        ...
        public StrategyTradeRuleMMForm()
        {
            InitializeComponent();
        ...
        private void TradeRuleForm_Load(object sender, EventArgs e)
        {
            ...
            rule.BasePriceDowns = new List<double>();
            rule.BasePriceUps = new List<double>();
            rule.BasePriceDowns.AddRange(new double[] { 0, 0, 0 });
            rule.BasePriceUps.AddRange(new double[] { 0, 0, 0 });
        }
        ...
        {
            if (tbBasePriceUp.Text.Length == 0) return;
            rule.BasePriceUps[0] = Convert.ToDouble(tbBasePriceUp.Text);
        }
        private void tbBasePriceUp2_TextChanged(object sender, EventArgs e)
        {
            if (tbBasePriceUp2.Text.Length == 0) return;
            rule.BasePriceUps[1] = Convert.ToDouble(tbBasePriceUp2.Text);
        }

        private void tbBasePriceUp3_TextChanged(object sender, EventArgs e)
        {
            if (tbBasePriceUp3.Text.Length == 0) return;
            rule.BasePriceUps[2] = Convert.ToDouble(tbBasePriceUp3.Text);
        }

        private void tbBasePriceDown_TextChanged(object sender, EventArgs e)
        {
            if (tbBasePriceDown.Text.Length == 0) return;
            rule.BasePriceDowns[0] = Convert.ToDouble(tbBasePriceDown.Text);
        }

        private void tbBasePriceDown2_TextChanged(object sender, EventArgs e)
        {
            if (tbBasePriceDown2.Text.Length == 0) return;
            rule.BasePriceDowns[1] = Convert.ToDouble(tbBasePriceDown2.Text);
        }

        private void tbBasePriceDown3_TextChanged(object sender, EventArgs e)
        {
            if (tbBasePriceDown3.Text.Length == 0) return;
            rule.BasePriceDowns[2] = Convert.ToDouble(tbBasePriceDown3.Text);
        }
